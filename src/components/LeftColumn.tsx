    ...
    <div className="left-side">
      ...
      <div className="listing product-rating bg-white p-5">
        ...
        <div className="flex">
          ...
          <img src={fivestars} alt="5 stars" className="ml-1" />
        </div>
        <div className="flex">
          <input type="radio" name="coolradio" value="two" />
          <img src={fourstars} alt="4 stars" className="ml-1" />
        </div>
        <div className="flex">
          <input type="radio" name="coolradio" value="three" />
          <img src={threestars} alt="3 stars" className="ml-1" />
        </div>
        <div className="flex">
          <input type="radio" name="coolradio" value="four" />
          <img src={twostars} alt="2 stars" className="ml-1" />
        </div>
        <div className="flex">
          <input type="radio" name="coolradio" value="five" />
          <img src={onestar} alt="1 star" className="ml-1" />
        </div>
      </div>
